<template>
  <be-breadcrumb>
    <be-breadcrumb-item to="/苏洵">苏洵</be-breadcrumb-item>
    <be-breadcrumb-item :option="list" :clickOption="handleClickOption" to="/苏轼">苏轼</be-breadcrumb-item>
    <be-breadcrumb-item to="/苏辙">苏辙</be-breadcrumb-item>
  </be-breadcrumb>
</template>
...
export default {
  setup(){
    ...
    const handleClickOption = (params) =>{
      console.log(params)
    }
    return {
      list,
