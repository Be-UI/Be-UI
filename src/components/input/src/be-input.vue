...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        nextTick(() => {
            curInstInputRefs = internalInstance.refs.beInputInner && reactive(internalInstance.refs.beInputInner as IInputInst)
            curInstAreaRefs = internalInstance.refs.beInputAreaInner && reactive(internalInstance.refs.beInputAreaInner as IInputInst)
