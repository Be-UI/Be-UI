...
describe('test-be-ellipsis-props', () => {
    ...
    test('props-content',  async () => {
        ...
        const elm:HTMLElement | null = wrapper.find('[data-test="be_ellipsis_test_content"]').element.parentElement
        await asyncExpect(()=>{
    ...
    // 是否多行展开
      test('props-expandTrigger', async () => {
          ...
          const elm:HTMLElement = wrapper.find('[data-test="be_ellipsis_test_expandTrigger"]').element as HTMLElement
    ...
    test('props-lineClamp', async () => {
        ...
        const elm:HTMLElement = wrapper.find('[data-test="be_ellipsis_test_elpNum"]').element as HTMLElement
        const elmStyle:CSSStyleDeclaration = elm.style
        await asyncExpect(()=>{
            expect(elmStyle.display === '-webkit-inline-box').toBeTruthy()
        },null)
