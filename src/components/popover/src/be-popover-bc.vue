    ...
    <teleport to="body">
        ...
        <div class="be-popover"
            ...
            <div   :id="`be_popover_arrow${uid}`"
                   :class="`be-popover-arrow--${place}`"
                   v-if="raw">
                <div class="be-popover-arrow"  :class="`be-popover-arrow--${place}`">
                </div>
            </div>
        </div>
    </teleport>
...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        const computePosition = (placement: string): void => {
            ...
            let arrow: HTMLElement = document.getElementById(`be_popover_arrow${internalInstance.uid}`) as HTMLElement
            let popoverOption = {
