...
describe('test-be-message-box-props', () => {
    ...
    test('props-titles', () => {
        ...
        const span:HTMLElement  = elm.querySelector('.text-warning') as HTMLElement
        asyncExpect(()=>{
    ...
    test('props-isOpenModal', () => {
        ...
        const elmModal:HTMLElement = document.body.querySelector('.props-isOpenModal-true') as HTMLElement
        const elmUnModal:HTMLElement = document.body.querySelector('.props-isOpenModal-false') as HTMLElement
        asyncExpect(()=>{
    ...
    test('props-type', () => {
        ...
        const elmWarning:HTMLElement = document.body.querySelector('.props-type-warning') as HTMLElement
        const elmInfo:HTMLElement = document.body.querySelector('.props-type-info') as HTMLElement
        const elmSuccess:HTMLElement = document.body.querySelector('.props-type-success') as HTMLElement
        ...
        asyncExpect(()=>{
            ...
            expect(elmWarning.className.indexOf('be-message-box__info') > -1 ).toBeTruthy()
            expect(elmWarning.className.indexOf('be-message-box__success') > -1 ).toBeTruthy()
            expect(elmWarning.className.indexOf('be-message-box__error') > -1 ).toBeTruthy()
        },null)
    })
    ...
    test('props-iconPreRender-iconNextRender', () => {
        ...
        const elmIconNext:HTMLElement = document.body.querySelector('#props_iconNextRender') as HTMLElement
        const elmIconPre:HTMLElement = document.body.querySelector('#props_iconPreRender') as HTMLElement
        asyncExpect(()=>{
